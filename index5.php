...
<div class="hero5-slider-section">
    <div class="hero5-section-area " style="background-image: url(assets/img/all-images/hero/hero-img4.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
        <img src="assets/img/all-images/bg/bg6.png" alt="" class="bg6">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="hero5-heading">
                        <h5 data-aos="fade-left" data-aos-duration="800">Expert Insights to Drive Business </h5>
                        <div class="space18"></div>
                        <h1 class="text-anime-style-3">Achieve Your Goals For Tailored Business Consulting Services</h1>
                        <div class="space14"></div>
                        <p data-aos="fade-left" data-aos-duration="900">Unlocking your business's potential starts with expert guidance, Our consultants at Advicx bring years of industry of experience.</p>
                        <div class="space24"></div>
                        <div class="btn-area1" data-aos="fade-left" data-aos-duration="1000">
                            <a href="contact.html" class="vl-btn5"><span class="text">Get Expert Advice Now</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-1"></div>
                <div class="col-lg-5" data-aos="zoom-in-up" data-aos-duration="1000">
                    <div class="header-contact-boxarea">
                        ...
                        <div class="input-area">
                            <select name="country" id="country3" class="country-area nice-select">
                                ...
                                <option value="">Investment Services</option>
                                <option value="">Insurance Services</option>
                                <option value=""> Lending Services</option>
                        ...
                        <div class="input-area">
                            <button type="submit" class="vl-btn5"><span class="text">Submit Now</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="hero5-section-area " style="background-image: url(assets/img/all-images/hero/hero-img5.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
        <img src="assets/img/all-images/bg/bg6.png" alt="" class="bg6">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="hero5-heading">
                        <h5>Expert Insights to Drive Business </h5>
                        <div class="space18"></div>
                        <h1>Achieve Your Goals For Tailored Business Consulting Services</h1>
                        <div class="space14"></div>
                        <p>Unlocking your business's potential starts with expert guidance, Our consultants at Advicx bring years of industry of experience.</p>
                        <div class="space24"></div>
                        <div class="btn-area1">
                            <a href="contact.html" class="vl-btn5"><span class="text">Get Expert Advice Now</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
    ...
    <div class="hero5-section-area " style="background-image: url(assets/img/all-images/hero/hero-img6.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
        <img src="assets/img/all-images/bg/bg6.png" alt="" class="bg6">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6">
        <div class="about-header heading5">
          ...
          <div class="btn-area1" data-aos="fade-left" data-aos-duration="1000">
            <a href="about.html" class="vl-btn5"><span class="text">about us</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></a>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-lg-5">
        <div class="heading5 space-margin60">
          <h5>OUR SERVICE</h5>
          <div class="space20"></div>
          <h2 class="text-anime-style-3">Professional Services for Business Success</h2>
        </div>
      </div>
    </div>
        ...
        <div class="service-single-slider owl-carousel">
          <div class="service-boxarea">
            ...
            <div class="content-area">
              <div class="icons">
                <img src="assets/img/icons/service16.svg" alt="">
              </div>
              <div class="space24"></div>
              <a href="service-single.html">Investment Management</a>
            </div>
            <div class="service-other-box" style="background-image: url(assets/img/all-images/service/service-img1.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
              <div class="icons">
                <img src="assets/img/icons/service16.svg" alt="">
              </div>
              <div class="space24"></div>
              <a href="service-single.html">Investment Management </a>
              <div class="space16"></div>
              <p>Our team works closely with you to create customized risk management.</p>
              <div class="space24"></div>
              <a href="service-single.html" class="learnmore">Read More <i class="fa-solid fa-arrow-right"></i></a>
            </div>
          </div>
          ...
          <div class="service-boxarea">
            ...
            <div class="content-area">
              <div class="icons">
                <img src="assets/img/icons/service17.svg" alt="">
              </div>
              <div class="space24"></div>
              <a href="service-single.html">Budgeting And Forecasting </a>
            </div>

            <div class="service-other-box" style="background-image: url(assets/img/all-images/service/service-img2.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
              <div class="icons">
                <img src="assets/img/icons/service17.svg" alt="">
              </div>
              <div class="space24"></div>
          ...
          <div class="service-boxarea">
            ...
            <div class="content-area">
              <div class="icons">
                <img src="assets/img/icons/service18.svg" alt="">
              </div>
              <div class="space24"></div>
              <a href="service-single.html">Financial Growth</a>
            </div>
            <div class="service-other-box" style="background-image: url(assets/img/all-images/service/service-img3.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
              <div class="icons">
                <img src="assets/img/icons/service18.svg" alt="">
              </div>
              <div class="space24"></div>
    ...
    <div class="row">
      <div class="col-lgg-6 m-auto">
        <div class="heading5 text-center space-margin60">
          <h5>How it work</h5>
          <div class="space16"></div>
          <h2 class="text-anime-style-3">From Strategy to Execution</h2>
        </div>
        <div class="space20"></div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6" data-aos="zoom-in-up" data-aos-duration="800">
        <div class="work-single-boxarea">
          <img src="assets/img/elements/elements37.png" alt="" class="elements12">
          <div class="icons">
            <img src="assets/img/elements/elements39.png" alt="" class="elements14">
            <div class="icon">
          ...
          <div class="conten-area">
            ...
            <div class="space16"></div>
            <p>This approach ensures that every decision is data-driven and focused on delivering tangible results. With ongoing support and regular check-ins.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6" data-aos="zoom-in-up" data-aos-duration="900">
        <div class="work-single-boxarea">
          <img src="assets/img/elements/elements38.png" alt="" class="elements13">
          <div class="icons">
            <img src="assets/img/elements/elements39.png" alt="" class="elements14">
            <div class="icon">
          ...
          <div class="conten-area">
            ...
            <div class="space16"></div>
            <p>We conduct in-depth assessments to identify strengths, weaknesses, and opportunities tailored to your unique situation once we have a clear picture.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6" data-aos="zoom-in-up" data-aos-duration="1000">
        <div class="work-single-boxarea">
          ...
          <div class="conten-area">
            ...
            <div class="space16"></div>
            <p>Our proven process, known 'Discovery & Strategy,' begins with a thorough understanding of your business and financial goals.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7 m-auto">
        <div class="heading5 space-margin60 text-center">
          <h5 data-aos="fade-left" data-aos-duration="800">Our Projects</h5>
          <div class="space16"></div>
          <h2 class="text-anime-style-3">Exceptional Project Execution</h2>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="project5-singlebox-slider owl-carousel">
          <div class="project-single-boxarea3">
            <div class="img1">
              <img src="assets/img/all-images/project/project-img14.png" alt="">
            </div>
            <div class="content-area">
              <div class="text">
              ...
              <a href="project-single.html" class="arrow"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M5.83594 14.1654L14.1693 5.83203M14.1693 5.83203H6.66927M14.1693 5.83203V13.332" stroke="#FB8500" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg></a>
            </div>
          </div>
          ...
          <div class="project-single-boxarea3">
            <div class="img1">
              <img src="assets/img/all-images/project/project-img15.png" alt="">
            </div>
            <div class="content-area">
              <div class="text">
          ...
          <div class="project-single-boxarea3">
            <div class="img1">
              <img src="assets/img/all-images/project/project-img16.png" alt="">
            </div>
            <div class="content-area">
              <div class="text">
                <p>Business And Finance</p>
    ...
    <div class="row">
      <div class="col-lg-5">
        <div class="heading5">
          ...
          <div class="space16"></div>
          <h2 class="text-anime-style-3">See How We’ve Helped Businesses Achieve.</h2>
          <div class="space16"></div>
          <p data-aos="fade-left" data-aos-duration="900">Their personalized approach and dedication our success set them apart. We saw tangible results within months and couldn’t happier with the outcome.’ We are honored to play a part in helping.</p>
          <div class="space32"></div>
          <div class="author-boxarea" data-aos="fade-left" data-aos-duration="1000">
            <div class="autho-star">
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                <path d="M25.8405 24.9906L29.1255 35.1036L18.006 27.0216L25.8405 24.9906ZM36 13.9506H22.2525L18.0075 0.869141L13.7475 13.9536L0 13.9356L11.133 22.0311L6.873 35.1021L18.006 27.0216L24.8805 22.0311L36 13.9506Z" fill="#FB8500"/>
              </svg>
              <div class="text">
                <h6>Trustpilot</h6>
      ...
      <div class="col-lg-1"></div>
      <div class="col-lg-6">
        <div class="testimonial6-widget-boxarea owl-carousel">
          <div class="testimonial-boxarea">
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none">
              <path d="M32.0204 20.6095C32.0204 22.8095 32.5954 24.657 33.7454 26.152C34.5604 27.182 35.6662 27.8586 37.0629 28.182C38.4379 28.502 39.7379 28.5245 40.9129 28.252C41.3129 30.627 40.6629 33.142 39.0129 35.807C37.3596 38.4703 35.2279 40.4728 32.6179 41.8145L36.5704 47.502C38.5704 46.512 40.4704 45.257 42.2204 43.7395C43.9954 42.222 45.5704 40.477 46.9704 38.5045C48.3704 36.532 49.4204 34.3045 50.0954 31.7795C50.7704 29.2545 50.9579 26.6795 50.6354 24.0295C50.2154 20.5295 49.0854 17.7295 47.2454 15.6544C45.4071 13.5528 43.1171 12.5019 40.3754 12.5019C37.9629 12.5019 35.9604 13.227 34.3754 14.6969C32.8071 16.137 32.0237 18.1103 32.0254 20.617L32.0204 20.6095ZM9.21039 20.6095C9.21039 22.8095 9.78539 24.657 10.9354 26.152C11.7521 27.202 12.8579 27.8828 14.2529 28.1945C15.6529 28.5028 16.9362 28.5211 18.1029 28.2495C18.5029 30.5995 17.8779 33.1245 16.2229 35.7995C14.5729 38.4495 12.4429 40.4495 9.83289 41.7995L13.7754 47.502C15.7771 46.512 17.6604 45.2578 19.4254 43.7395C21.2164 42.1993 22.8071 40.4406 24.1604 38.5045C25.5504 36.5295 26.5854 34.3045 27.2604 31.7795C27.9461 29.2564 28.1304 26.6234 27.8029 24.0295C27.3879 20.5295 26.2629 17.7295 24.4279 15.6544C22.5946 13.5678 20.3087 12.5245 17.5704 12.5245C15.1537 12.5211 13.1521 13.2519 11.5654 14.7169C9.99706 16.1569 9.21206 18.1303 9.21039 20.6369V20.6095Z" fill="#FB8500"/>
            </svg>
            <div class="space28"></div>
            <p>“Our clients' success is at the heart of everything we do. We pride ourselves on building long-lasting relationships & delivering results that make a real difference. One client shared, Finazze provided the strategic guidance.”</p>
            <div class="space28"></div>
            <div class="auhtor-text">
              <a href="#">Gabriel Krajcik</a>
              <div class="space12"></div>
              <p>Businessman</p>
            </div>
          </div>
...
<div class="vl-blog-5-area sp2">
  <div class="container">
     <div class="row">
        <div class="col-lg-6 m-auto">
           <div class="vl-blog-1-section-box heading5 text-center space-margin60">
      ...
      <div class="col-lg-6 col-md-12" data-aos="zoom-in-up" data-aos-duration="900">
        <div class="vl-blog-1-item">
          <div class="vl-blog-1-content">
            ...
            <div class="space24"></div>
            <h4 class="vl-blog-1-title"><a href="blog-single.html">The Top 5 Financial Mistakes Businesses Finance Make  & How to Avoid Them</a></h4>
         </div>
           <div class="vl-blog-1-thumb image-anime">
              <img src="assets/img/all-images/blog/blog-img10.png" alt="">
              <div class="vl-blog-1-icon">
                <a href="blog-single.html"><svg xmlns="http://www.w3.org/2000/svg" width="49" height="49" viewBox="0 0 49 49" fill="none">
                  <path d="M16.0918 32.8674L32.426 16.5333" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M19.0605 16.5315H32.4249V29.8958" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg></a>
             </div>
           </div>
        </div>
     ...
     <div class="col-lg-6 col-md-12" data-aos="zoom-in-up" data-aos-duration="1000">
      <div class="vl-blog-1-item">
        <div class="vl-blog-1-content">
          <div class="vl-blog-meta">
             <ul>
              ...
              <li>
                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                <path d="M4.9668 17.5C4.9668 14.2783 7.57847 11.6667 10.8001 11.6667C14.0218 11.6667 16.6335 14.2783 16.6335 17.5M14.1335 5.83333C14.1335 7.67428 12.641 9.16667 10.8001 9.16667C8.95918 9.16667 7.4668 7.67428 7.4668 5.83333C7.4668 3.99238 8.95918 2.5 10.8001 2.5C12.641 2.5 14.1335 3.99238 14.1335 5.83333Z" stroke="#061D19" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg> By Jos Buttler</a>
            </li>
             </ul>
          </div>
          <div class="space24"></div>
          <h4 class="vl-blog-1-title"><a href="blog-single.html">Mastering Financial Strategies Helping You Make Informed Decisions for Long</a></h4>
       </div>
         <div class="vl-blog-1-thumb image-anime">
...
<div class="cta5-section-area">
  <div class="container">
      <div class="row">
          <div class="col-lg-12">
              <div class="cta-bg-area" data-aos="fade-down" data-aos-duration="1000">
                  <div class="row align-items-center">
                      <div class="col-lg-7">
                          <div class="heading2">
                              <h2>Empowering Businesses, <br class="d-lg-block d-none"> One Step at a Time</h2>
                              <img src="assets/img/elements/elements17.png" alt="" class="elements17 aniamtion-key-1">
                          </div>
                          <div class="row">
                              ...
                              <div class="cta-author-area">
                                <div class="icons">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none">
                                    <path d="M5.66667 25.4987L12.75 16.9987M28.3333 25.4987L21.25 16.9987M4.25 11.332L14.4854 18.1555C15.3942 18.7615 15.8485 19.0645 16.3397 19.1821C16.7738 19.2862 17.2262 19.2862 17.6603 19.1821C18.1515 19.0645 18.6058 18.7615 19.5146 18.1555L29.75 11.332M8.78333 26.9154H25.2167C26.8035 26.9154 27.597 26.9154 28.203 26.6065C28.7361 26.335 29.1696 25.9015 29.4412 25.3684C29.75 24.7623 29.75 23.9688 29.75 22.382V11.6154C29.75 10.0286 29.75 9.23514 29.4412 8.62906C29.1696 8.09593 28.7361 7.66248 28.203 7.39085C27.597 7.08203 26.8035 7.08203 25.2167 7.08203H8.78333C7.19652 7.08203 6.40311 7.08203 5.79703 7.39085C5.26389 7.66248 4.83045 8.09593 4.55882 8.62906C4.25 9.23514 4.25 10.0285 4.25 11.6154V22.382C4.25 23.9688 4.25 24.7623 4.55882 25.3684C4.83045 25.9015 5.26389 26.335 5.79703 26.6065C6.40311 26.9154 7.19651 26.9154 8.78333 26.9154Z" stroke="#FB8500" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                  </svg>
                                </div>
                                <div class="text">
                                  <p>Mail Us Anytime</p>
                                  <div class="space18"></div>
                                  <a href="mailto:finazze@gmail.com">finazze@gmail.com</a>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="col-lg-5">
                          <div class="cta-images-area">
                              <div class="img1">
                                <img src="assets/img/all-images/cta/cta-img2.png" alt="">
                              </div>
                          </div>
                      </div>
                  </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6">
        ...
        <div class="vl-footer-widget">
          ...
          <div class="space4"></div>
          <ul>
            <li><a href="about.html">Financial Strategy</a></li>
            <li><a href="service.html">Business Growth</a></li>
            <li><a href="project.html">Our Process</a></li>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="vl-footer-widget">
          ...
          <ul>
            ...
            <li><a href="mailto:finazzeconsult@gmail.com"><img src="assets/img/icons/email1.svg" alt="">finazzeconsult@gmail.com</a></li>
