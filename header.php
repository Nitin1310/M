                                          ...
                                          <div class="row gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                                              <div class="col">
                                                      <div class="vl-home-thumb">
                                                         ...
                                                         <a href="index.php">Finazze  - Homepage 01</a>
                                                         <div class="btn-area1">
                                                          <a href="index.php" class="vl-btn1">View Demo</a>
                                              ...
                                              <div class="col">
                                                      <div class="vl-home-thumb">
                                                        ...
                                                        <a href="index2.php">Finazze  - Homepage 02</a>
                                                        <div class="btn-area1">
                                                          <a href="index2.php" class="vl-btn1">View Demo</a>
                                              ...
                                              <div class="col ">
                                                      <div class="vl-home-thumb">
                                                        ...
                                                        <a href="index3.php">Finazze  - Homepage 03</a>
                                                        <div class="btn-area1">
                                                          <a href="index3.php" class="vl-btn1">View Demo</a>
                                              ...
                                              <div class="col ">
                                                      <div class="vl-home-thumb">
                                                        ...
                                                        <a href="index4.php">Finazze  - Homepage 04</a>
                                                        <div class="btn-area1">
                                                          <a href="index4.php" class="vl-btn1">View Demo</a>
                                              ...
                                              <div class="col ">
                                                    <div class="vl-home-thumb">
                                                      ...
                                                      <a href="index5.php">Finazze  - Homepage 05</a>
                                                      <div class="btn-area1">
                                                        <a href="index5.php" class="vl-btn1">View Demo</a>
                                                       </div>
                                                    </div>
                                            </div>
                                          </div>
