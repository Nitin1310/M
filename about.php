...
<!-- Mirrored from unifato.com/finazze/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Jan 2026 19:37:05 GMT -->
...
<body>
                ...
                <ul>
                  ...
                  <li><a href="#">Services <span><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                    <ul class="sub-menu">
                      ...
                      <li><a href="#" class="span-arrow">Service Details <span><i
                  ...
                  <li><a href="#">Project <span><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                    <ul class="sub-menu">
                      ...
                      <li><a href="#" class="span-arrow">Project Details <span><i
                              class="fa-solid fa-angle-right d-lg-block d-none"></i></span></a>
                        <ul class="sub-menu menu1">
                  ...
                  <li><a href="#">Blogs <span><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                    <ul class="sub-menu">
                      ...
                      <li><a href="#" class="span-arrow">Blog Details <span><i
                              class="fa-solid fa-angle-right d-lg-block d-none"></i></span></a>
                        <ul class="sub-menu menu1">
  ...
  <div class="inner-pages-section-area"
    style="background-image: url(assets/img/all-images/bg/hero-bg1.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
    <div class="container">
      <div class="row">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <div class="img2 reveal">
            <img src="assets/img/about/uPDATED-mAHA-SHIKSHAN-Abount-us.jpg" alt="About image">
          </div>
            ...
            <!-- <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                          <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">
                            <span class="icon"><img src="assets/img/icons/mission-icon3.svg" alt=""></span>
                  ...
                  <div class="">
                    <div class="heading1">
                      ...
                      <!-- <p>Our vision is to become a global leader in financial consulting, recognized for transforming businesses through strategic, data-driven solutions. We aim to foster a future businesses of all sizes can access the financial expertise.</p>
                                        <div class="space16"></div>
                                        <ul>
                                            <li><img src="assets/img/icons/check1.svg" alt=""> Client-Focused Solutions and Results</li>
                                            <li><img src="assets/img/icons/check1.svg" alt=""> Flexible, Value Driven Approach</li>
                                            <li><img src="assets/img/icons/check1.svg" alt=""> Warning of updated legal risks for customers</li>
                                            <li><img src="assets/img/icons/check1.svg" alt=""> A team of experienced and highly specialized</li>
                                        </ul>
                                        <div class="space32"></div>
                                        <div class="btn-area1">
                                            <a href="service.html" class="vl-btn1">Learn More</a>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <div class="heading1">
                                        <h2>Our Vission</h2>
                                        <div class="space16"></div>
                                        <p>Our mission is to empower businesses with innovative financial strategies that drive sustainable growth & long-term success. We are committed to providing tailored solutions that address the unique challenges of each client, ensuring.</p>
                                        <div class="space16"></div>
                                        <p>Our vision is to become a global leader in financial consulting, recognized for transforming businesses through strategic, data-driven solutions. We aim to foster a future businesses of all sizes can access the financial expertise.</p>
                                        <div class="space16"></div>
                                        <ul>
  ...
  <!-- <div class="testimonial-about-section-area sp1">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12" data-aos="fade-up" data-aos-duration="1000">
                <div class="testimonial2-slider-area owl-carousel">
                    <div class="testimonial2-boxarea">
                        <ul>
                        ...
                        <div class="space16"></div>
                        <p>“Our clients' success is at the heart of everything we do. We pride ourselves on building long-lasting relationships and delivering results that make a real difference. One client shared.”</p>
                        <div class="space20"></div>
                        <div class="author-images-area">
                            <div class="images">
                                <div class="img1">
                                    <img src="assets/img/all-images/testimonial/testi-img1.png" alt="">
                                </div>
                                <div class="text">
                            ...
                            <div class="quoto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
                                    <path d="M26.6837 17.173C26.6837 19.0063 27.1628 20.5459 28.1212 21.7917C28.8003 22.65 29.7219 23.2139 30.8857 23.4834C32.0316 23.75 33.1149 23.7688 34.0941 23.5417C34.4274 25.5209 33.8857 27.6167 32.5107 29.8375C31.133 32.057 29.3566 33.7257 27.1816 34.8438L30.4753 39.5834C32.142 38.7584 33.7253 37.7125 35.1837 36.448C36.6628 35.1834 37.9753 33.7292 39.142 32.0855C40.3087 30.4417 41.1837 28.5855 41.7462 26.4813C42.3087 24.3771 42.4649 22.2313 42.1962 20.023C41.8462 17.1063 40.9045 14.773 39.3712 13.0438C37.8392 11.2924 35.9309 10.4167 33.6462 10.4167C31.6357 10.4167 29.967 11.0209 28.6462 12.2459C27.3392 13.4459 26.6864 15.0903 26.6878 17.1792L26.6837 17.173ZM7.67533 17.173C7.67533 19.0063 8.1545 20.5459 9.11283 21.7917C9.79338 22.6667 10.7149 23.2341 11.8774 23.4938C13.0441 23.7507 14.1135 23.766 15.0857 23.5396C15.4191 25.498 14.8982 27.6021 13.5191 29.8313C12.1441 32.0396 10.3691 33.7063 8.19408 34.8313L11.4795 39.5834C13.1476 38.7584 14.717 37.7132 16.1878 36.448C17.6803 35.1645 19.0059 33.6989 20.1337 32.0855C21.292 30.4396 22.1545 28.5855 22.717 26.4813C23.2884 24.3788 23.442 22.1846 23.1691 20.023C22.8232 17.1063 21.8857 14.773 20.3566 13.0438C18.8288 11.3049 16.9239 10.4355 14.642 10.4355C12.6281 10.4327 10.9601 11.0417 9.63783 12.2625C8.33088 13.4625 7.67672 15.107 7.67533 17.1959V17.173Z" fill="#9EDD05"/>
                                  </svg>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial2-boxarea">
                        ...
                        <div class="space16"></div>
                        <p>“One client shared provide The strategic guidance we needed to streamline our finances and scale our business. Their personalized approach and dedication to our success set them apart.”</p>
                        <div class="space20"></div>
                        <div class="author-images-area">
                            <div class="images">
                                <div class="img1">
                                    <img src="assets/img/all-images/testimonial/testi-img2.png" alt="">
                                </div>
                                <div class="text">
                    ...
                    <div class="testimonial2-boxarea">
                        ...
                        <div class="space16"></div>
                        <p>“The team was not only knowledgeable but also genuinely invested our success.  I can't recommend them enough!' These testimonials reflect our commitment to delivering exceptional results & building.”</p>
                        <div class="space20"></div>
                        <div class="author-images-area">
                            <div class="images">
                                <div class="img1">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration="800">
          <div class="team-boxarea">
            ...
            <div class="content-area">
              <a href="team.html">Erma Hansen</a>
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration="900">
          <div class="team-boxarea">
            ...
            <div class="space24"></div>
            <div class="content-area">
              <a href="team.html">Ignacio Goldner</a>
              <div class="space8"></div>
              <p>Management Advisor</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration="1100">
          <div class="team-boxarea">
            ...
            <div class="space24"></div>
            <div class="content-area">
              <a href="team.html">Cesar Schuster</a>
              <div class="space8"></div>
              <p>Debt Management </p>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="footer-logo1">
            ...
            <p>Welcome to Your Trusted Educational Consultancy team, where we are dedicated to shaping dreams into
              ...
              aspirations by providing expert guidance and personalized support throughout their educational journey.
            </p>
            <div class="space24"></div>
            <ul>
              <li><a href="#"><i class="fa-brands fa-facebook-f"></i></a></li>
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <div class="vl-footer-widget first-padding">
            ...
            <ul>
              ...
              <li><a href="#">Competitive Examination</a></li>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="vl-footer-widget">
            ...
            <h3>Contact Us</h3>
            <ul>
              <li><a href="tel:+11234567890"><img src="assets/img/icons/phn1.svg" alt="">+91 90283 19393 | +91
                  9226471071</a></li>
              <!-- <li><a href="#"><img src="assets/img/icons/location1.svg" alt="">421 Allen, Mexico 4233</a></li> -->
              <li><a href="renevagency%40com.html"><img src="assets/img/icons/email1.svg"
                    alt="">info@mahashikshan.com</a></li>
              <li><a href="#"><img src="assets/img/icons/global1.svg" alt="">info@mahashikshan.com</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="vl-copyright-area">
              <p>© Copyright 2025 - Maharashtra Education Careers. All rights reserved. Designed & Developed by TSS.</p>
            </div>
          </div>
        </div>
      </div>
...
<!-- Mirrored from unifato.com/finazze/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Jan 2026 19:37:07 GMT -->
